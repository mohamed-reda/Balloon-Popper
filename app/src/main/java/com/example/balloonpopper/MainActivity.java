...
public class MainActivity extends AppCompatActivity implements Balloon.BalloonListener{
    ...
    private static final int MIN_ANIMATION_DURATION = 600;
    private static final int MAX_ANIMATION_DURATION = 3000;
    private static final int NUMBER_OF_PINS = 5;
    private static final int BALLOONS_PER_LEVEL = 25;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBalloonColors[1] = Color.argb(255, 128, 128, 0);
    ...
    private void pauseGame() {
        if(mLevel>0)
            mLevel--;
        if(mPlaying)
            Toast.makeText(this, "You paused Game!", Toast.LENGTH_SHORT).show();
